...
export const login = async (
    ...
    try {
        ...
        if (!user){
            return createErrorResponse(ErrorCodes.INVALID_CREDENTIALS, "Invalid credentials");
        }
        ...
        console.log(e);
		return createErrorResponse(ErrorCodes.SERVER_ERROR, "Internal server error");
    }
}
