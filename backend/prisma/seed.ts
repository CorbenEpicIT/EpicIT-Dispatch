	...
	const [contact1, contact2, contact3, contact4, contact5, contact6] = await Promise.all([
		...
		db.contact.create({
			data: {
				...
				phone: "6082551002",
				company: "Smith Commercial Properties",
		...
		db.contact.create({
			data: {
				...
				phone: "6082551004",
				company: "Anderson Office Complex",
		...
		db.contact.create({
			data: {
				...
				type: "customer",
				misc_info: "Holds security badge access. Direct line for mechanical room entry.",
			},
		}),
		db.contact.create({
			data: {
				...
				phone: "6082551006",
				company: "Riverside Apartments LLC",
				title: "Property Manager",
				type: "customer",
				misc_info: "Prefers email. Requires 48hr tenant notice before any unit access.",
			},
		}),
	]);
