...
// Reports require a concrete range, so the "all" preset is omitted.
const REPORT_PRESETS: DateRangeOption[] = [
	"today",
	"last_7_days",
	"last_30_days",
	"this_month",
		...
		<div className="min-h-0 bg-canvas text-text-primary w-full">
			<div className="w-full px-4 sm:px-5 lg:px-6 py-4">
				...
				<PageHeader title="Reports">
					<DateRangeFilter value={range} onChange={setRange} presets={REPORT_PRESETS} />
				</PageHeader>
